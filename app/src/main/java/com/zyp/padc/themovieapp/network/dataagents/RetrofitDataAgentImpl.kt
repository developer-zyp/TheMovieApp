...
import com.zyp.padc.themovieapp.network.TheMovieApi
import com.zyp.padc.themovieapp.network.responses.GetActorsResponse
import com.zyp.padc.themovieapp.network.responses.GetCreditsByMovieResponse
import com.zyp.padc.themovieapp.network.responses.GetGenresResponse
...
object RetrofitDataAgentImpl : MovieDataAgent {
    ...
    override fun getGenres(onSuccess: (List<GenreVO>) -> Unit, onFailure: (String) -> Unit) {
        mTheMovieApi?.getGenres()?.enqueue(object : Callback<GetGenresResponse> {
            override fun onResponse(
